...
def draw_main_window():
    ...
    title_v = tk.Label(
        window_,
        text='ChorDefine',  # 标签的文字
        bg='black', fg="white", # 标签背景颜色
        font=('Arial', 36),  # 字体和字体大小
        width=30, height=2,
        relief="raised", bd="5", )  # 标签长宽
    title_v.pack()  # 固定窗口位置
    ...
    text_load = tk.Label(
        ...
        width=10, height=4, fg='white')  # 标签长宽
...
if __name__ == "__main__":
    ...
    window_.geometry('1366x768')  # 窗口大小
    window_.minsize(1100, 550)
    window_.maxsize(1920, 1080)
    window_.configure(cursor="arrow", height=80, bg=BG_COLOUR)  # 背景色
